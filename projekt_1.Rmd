...
columns <- names(data)
string_columns <- c("Battery.ID", "Battery.Formula", "Working.Ion", "Formula.Charge", "Formula.Discharge")
numeric_columns <- setdiff(columns, string_columns)
...
```{r}
  ...
  #  labs(
  #    title = paste("Rozkład częstości występowania wartości dla zmiennej ", col),
  #    x = "Liczba wystąpień",
